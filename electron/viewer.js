...
if(kind==='video'){
  const shell=document.createElement('section'),video=document.createElement('video'),toolbar=document.createElement('div'),select=document.createElement('select'),speedSelect=document.createElement('select'),audioSelect=document.createElement('select'),subSelect=document.createElement('select'),previousVideo=document.createElement('button'),nextVideo=document.createElement('button'),autoNext=document.createElement('button'),subtitle=document.createElement('button'),pip=document.createElement('button'),capture=document.createElement('button'),status=document.createElement('div');
  ...
  toolbar.append(previousVideo,nextVideo,autoNext,select,speedSelect,audioSelect,subSelect,subtitle,pip,capture);shell.append(video,toolbar,status);root.replaceChildren(shell);load(0);
